...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cdecimal-feedstock/blob/master/LICENSE.txt)

Summary: Fast drop-in replacement for decimal.py

Documentation: http://www.bytereef.org/mpdecimal/doc/cdecimal/index.html
